...
public class BinarySearchTree<E extends Comparable<E>> extends AbstractTree<E> {
  ...
  public TreeNode<E> getNode(E e){
    ...
    /** Returns an ArrayList containing elements in the path 
    from the root leading to the specified element, 
        ...
        TreeNode<E> current = root; // Start from the root          
         ...
         while(current.element != e){
            ...
            if(current.right == null && current.left == null)
              ...
              list.add(current.left.element);
              current = current.left;
            }
            else{
              list.add(current.right.element);
              current = current.right;
            }
         }
    ...
    public void subtree(java.util.ArrayList<E> list, TreeNode<E> node){
      if(node!=null){
        list.add(node.element);
        subtree(list, node.left);
        subtree(list, node.right);
      }
    }
    ...
    public java.util.ArrayList<E> leftSubTree(E e){
       java.util.ArrayList<E> list = new java.util.ArrayList<>();
       TreeNode<E> current = getNode(e);
       subtree(list,current.left);
       return list;
    ...
    public java.util.ArrayList<E> rightSubTree(E e){
        java.util.ArrayList<E> list = new java.util.ArrayList<>();
       TreeNode<E> current = getNode(e);
       subtree(list,current.right);
       return list;
    }
    
    /* Returns the inorder predecessor of the specified element, 
    returns null if tree is empty or element 'e' is not in the tree. 
    */
   /*public E inorderPredecessor(E e){
    ...
    public boolean sameTree(TreeNode<E> tree1, TreeNode<E> tree2){
      ...
      if(tree1 == null && tree2 == null)
        return true;
      else if(tree1.element == tree2.element){        
